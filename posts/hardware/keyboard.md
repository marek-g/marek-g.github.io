...
Keymapper configuration for a single keyboard:
...
Keymapper configuration for two keyboards:
...
[system = "Windows"]
ContextActive >> $(msg * Rusty Split Keyboard Mode ON) ^ $(msg * Rusty Split Keyboard Mode OFFF)
